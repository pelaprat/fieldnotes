...
######################
## Log the activity ##
$lchc->log_user_activity( $user, { url    => 'browse/course.pl',
				   action => 'view',
			           target => "$course-$conference" });
...
print "<script type='text/javascript'>         \n" . 
      ...
      "function listImagesInOverlay(){         \n" .
      "    var imgHTML = '';                   \n" .
      "    \$('a[\@rel*=lightbox]').each(function () {   \n" .
      "         imgHTML += \"<img width='640' height='480' src='\" + this + \"'><br>\";        \n" .
      "     });                                                       \n" .
      "     \$('#imglistdiv').html(imgHTML);                          \n" .
      "}                                                              \n" . 
      "</script> \n";
